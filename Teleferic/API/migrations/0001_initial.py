# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2018-01-24 21:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='saltedMetaHashes', to='API.Object')),
            ],
        ),
        migrations.AddField(
            model_name='message',
